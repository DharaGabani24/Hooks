...
export default function UseStateHookTextform(props) {
  ...
  return (
    ...
    <div className='container'  style={{color:props.mode==='dark'?'white':'black'}}>
            ...
            <div className="mb-3">
            <textarea className="form-control" id="mybox" value={text} onChange={handleOnChange} style={{backgroundColor: props.mode==='dark'?'grey':'white',color:props.mode==='dark'?'white':'black' }}rows="5"></textarea>
            </div>
...
// const UseStateHook = () => {
//   const [myName,setMyName] = useState('hey hello everyone');

//   const changeName = () => {
//     let val = myName;
//     if (val === 'hey hello everyone'){
//       setMyName('byeeeeee')
//     } else {
//       setMyName('hey hello everyone')
//     }
//   }
//   return (
//     <div>
//       <h1>{myName}</h1>
//       <button className='btn btn-primary' onClick={changeName}>click to change the text</button>
//     </div>
//   )
// }
       )
